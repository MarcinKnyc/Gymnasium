  ...
  describe('(package)', function() {
    describe('Client', function() {
      ...
      it('should have the property passwordSalt (base name: "passwordSalt")', function() {
        // TODO: update the code to test the property passwordSalt
        expect(instance).to.have.property('passwordSalt');
        // expect(instance.passwordSalt).to.be(expectedValueLiteral);
      });
