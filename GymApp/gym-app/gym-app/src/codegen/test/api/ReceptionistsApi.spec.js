...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReceptionistsApi', function() {
      ...
      describe('apiReceptionistsGetByOwnerIdOwnerIdGet', function() {
        it('should call apiReceptionistsGetByOwnerIdOwnerIdGet successfully', function(done) {
          // TODO: uncomment, update parameter values for apiReceptionistsGetByOwnerIdOwnerIdGet call and complete the assertions
          /*

          instance.apiReceptionistsGetByOwnerIdOwnerIdGet(ownerId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
