...
export class PassBoughtEventsApi {
    ...
    */
     ...
     */
    apiPassBoughtEventsDeactivatePassPassBoughtEventIdPut(passBoughtEventId, callback) {
      
      let postBody = null;
      // verify the required parameter 'passBoughtEventId' is set
      if (passBoughtEventId === undefined || passBoughtEventId === null) {
        throw new Error("Missing the required parameter 'passBoughtEventId' when calling apiPassBoughtEventsDeactivatePassPassBoughtEventIdPut");
      }
      ...
      return this.apiClient.callApi(
        '/api/PassBoughtEvents/DeactivatePass/{passBoughtEventId}', 'PUT',
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    apiPassBoughtEventsExtendPassValidityPassBoughtEventIdPut(passBoughtEventId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'passBoughtEventId' is set
      if (passBoughtEventId === undefined || passBoughtEventId === null) {
        throw new Error("Missing the required parameter 'passBoughtEventId' when calling apiPassBoughtEventsExtendPassValidityPassBoughtEventIdPut");
      }
      ...
      return this.apiClient.callApi(
        '/api/PassBoughtEvents/ExtendPassValidity/{passBoughtEventId}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    apiPassBoughtEventsGetActivePassesClientIdGet(clientId, callback) {
      ...
      if (clientId === undefined || clientId === null) {
        throw new Error("Missing the required parameter 'clientId' when calling apiPassBoughtEventsGetActivePassesClientIdGet");
      }
      ...
      return this.apiClient.callApi(
        '/api/PassBoughtEvents/GetActivePasses/{clientId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
