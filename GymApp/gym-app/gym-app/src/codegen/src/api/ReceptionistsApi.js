...
export class ReceptionistsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the apiReceptionistsGetByOwnerIdOwnerIdGet operation.
     * @callback moduleapi/ReceptionistsApi~apiReceptionistsGetByOwnerIdOwnerIdGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ReceptionistsApi~apiReceptionistsGetByOwnerIdOwnerIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    apiReceptionistsGetByOwnerIdOwnerIdGet(ownerId, callback) {
      
      let postBody = null;
      // verify the required parameter 'ownerId' is set
      if (ownerId === undefined || ownerId === null) {
        throw new Error("Missing the required parameter 'ownerId' when calling apiReceptionistsGetByOwnerIdOwnerIdGet");
      }
      ...
      return this.apiClient.callApi(
        '/api/Receptionists/GetByOwnerId/{ownerId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
