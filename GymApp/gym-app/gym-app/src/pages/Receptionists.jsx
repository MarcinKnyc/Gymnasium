...
const ReceptionistsPage = ({ apiClient }) => {
  ...
  const handleAddFormSubmit = (e) => {
    e.preventDefault()
    const receptionist = { id: uuid(), ownerId: uuid(), ...addFormData }
  ...
  const handleEditFormSubmit = (e) => {
    ...
    const newData = [...data]
    const index = data.findIndex((receptionist) => receptionist.id === editReceptionistId)
  ...
  const handleDelete = (receptionistId) => {
    const newReceptionist = data.filter((receptionist) => receptionist.id !== receptionistId)
